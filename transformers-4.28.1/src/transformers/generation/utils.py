...
class GenerationMixin:
    ...
    def generate(
        ...
        **kwargs,
        ...
        model_kwargs_student = generation_config_student.update(**kwargs)  # All unused kwargs must be model kwargs
        generation_config.validate()
        generation_config_student.validate()
        ...
        inputs_tensor, model_input_name, model_kwargs = self._prepare_model_inputs(
            inputs_ids, generation_config.bos_token_id, model_kwargs
        )
        inputs_tensor_student, _, _ = self._prepare_model_inputs(
        ...
        input_ids_seq_length_student = input_ids_student.shape[-1]
        ...
        if is_greedy_gen_mode and deck_decoding:
            ...
            return self.deck_greedy_decode(
                input_ids,
                input_ids_student,
                logits_processor=logits_processor,
